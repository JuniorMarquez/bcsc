...
app.controller('solicitudesCtrl', ['$scope', '$http','$state', '$filter', '$modal', 'MyService', 'filterFilter', 'datepickerConfig',function($scope, $http,$state, $filter,$modal, MyService,filterFilter, datepickerConfig) {
...
$scope.openDetalles = function(item){
  MyService.data.solicitudConsultar = null;
  MyService.data.solicitudConsultar = item;
  $state.go('app.detallesSolicitud');
  };
