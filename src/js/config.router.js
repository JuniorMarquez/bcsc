      ...
      function ($stateProvider,   $urlRouterProvider) {
          ...
          $stateProvider
              ...
              .state('app.dashboard-v1', {
               ...
               .state('app.clientes', {
                  url: '/clientes',
                  templateUrl: 'tpl/app_clientes.html',
                  resolve: {
                      deps: ['$ocLazyLoad',
                        function( $ocLazyLoad ){
              ...
              .state('app.solicitudes', {
                  url: '/solicitudes',
                  templateUrl: 'tpl/app_solicitudes.html',
                  resolve: {
                      deps: ['$ocLazyLoad',
                        function( $ocLazyLoad ){
                          return $ocLazyLoad.load(['ui.select','toaster','ngGrid']).then(
                              function(){
                                  return $ocLazyLoad.load([
                                    'js/controllers/chart.js',
                                                  'js/controllers/bootstrap.js',
                                                  'js/app/solicitudes/solicitudes.js'
                                                  ]);
                              }
                          );
                      }]
...
.state('apps.consultores', {
                  url: '/consultores',
                  templateUrl: 'tpl/apps_consultores.html',
                   resolve: {
                      deps: ['$ocLazyLoad',
                        function( $ocLazyLoad ){
                          return $ocLazyLoad.load(['ui.select','toaster']).then(
                              function(){
                                return $ocLazyLoad.load( ['js/app/consultores/consultores.js',
                                  'js/controllers/chart.js',
                                'js/controllers/bootstrap.js'
                                                  ]);
                              }
...
.state('app.detallesSolicitud', {
                  url: '/detallesSolicitud',
                  templateUrl: 'tpl/app_detallesSolicitud.html',
                   resolve: {
                      deps: ['$ocLazyLoad',
                        function( $ocLazyLoad ){
                          return $ocLazyLoad.load(['ui.select','toaster']).then(
...
//               })
.state('apps.detallesSolicitudMacho', {
